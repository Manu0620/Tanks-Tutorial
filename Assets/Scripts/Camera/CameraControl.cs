...
public class CameraControl : MonoBehaviour
{
    ...
    /*[HideInInspector]*/ 
    public Transform[] m_Targets; //Array de tanques, nose mostrarán en el inspector cuando haya Game Manager
    ...
    private void FindAveragePosition()
    {
        ...
        int numTargets = 0;
        //Recorre la cantidad de tanques activos, captura su posición y asignaa m_DesiredPosition el punto medio entre ellos (en el eje Y)
