...
public class TankShooting : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //Velocidad de carga, basasda en el máximo tiempo de carga y los valor es de carga máximo y mínimo
    ...
    private void Fire()
    {
        ...
        m_ShootingAudio.Play();
        //Reseteo la fuerza de lanzamiento como precaución ante posibles eventSos de botón "perdidos".
        m_CurrentLaunchForce = m_MinLaunchForce;
    }
